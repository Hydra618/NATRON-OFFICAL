module.exports = {
	...
	run: async (client, message, args, prefix) => {
		...
		message.guild.channels.create(`ticket-${message.author.id}`, {
			...
			channel.send(`Hi ${message.author}, welcome to your ticket! Please be patient, we will be with you shortly. If you would like to close this ticket please run \`+close\` or if yoy want to delte this ticket please run \`+delete\``);
